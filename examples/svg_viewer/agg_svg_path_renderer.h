...
#include <string.h>		// ×£ÏþÓ¥Ìí¼Ó 2014-02-14
...
namespace svg
{
    ...
    struct path_attributes
    {
        ...
        rgba8        fill_color;
        rgba8        stroke_color;
		double		fill_opacity;	// ×£ÏþÓ¥Ìí¼Ó 2014-02-16
        ...
        path_attributes() :
			...
			fill_opacity  ( 1.0 ),	// ×£ÏþÓ¥Ìí¼Ó 2014-02-16
			stroke_opacity( 1.0 ),	//
            fill_flag(true),
            stroke_flag(false),
            even_odd_flag(false),
        ...
        path_attributes(const path_attributes& attr) :
			...
			fill_opacity  ( attr.fill_opacity   ),	// ×£ÏþÓ¥Ìí¼Ó 2014-02-16
                    ...
                    double opacity=1.0)
        {
            ...
            for(i = 0; i < m_attr_storage.size(); i++)
            {
                ...
                if(attr.fill_flag)
                {
					...
					*/
					color.opacity( attr.fill_opacity * opacity ); // ×£ÏþÓ¥Ìí¼Ó 2014-02-16
                    ren.color(color);
                ...
                if(attr.stroke_flag)
                {
                    ...
                    color.opacity(color.opacity() * opacity);
					*/
					color.opacity( attr.stroke_opacity * opacity); // ×£ÏþÓ¥Ìí¼Ó 2014-02-16
                    ren.color(color);
                    agg::render_scanlines(ras, sl, ren);
                }
            }
